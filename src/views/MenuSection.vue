<template>
    <div class="container">
        <div :id="section.categoria_id" class=" container-button"
            v-for="(section, index) in cart?.menu?.listaCategorias?.sort((a, b) => codigos.indexOf(parseInt(a.categoria_id)) - codigos.indexOf(parseInt(b.categoria_id)))"
